    ...
    <div className="min-h-screen flex items-center justify-center p-8 relative overflow-hidden"
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        >
          ...
          {/* Main heading */}
          <motion.h1 
            className="text-5xl md:text-6xl font-bold text-purple-700 mb-6 drop-shadow-lg"
          ...
          {/* Subtitle */}
          <motion.h2 
            className="text-3xl md:text-4xl text-purple-800 font-light mb-8 drop-shadow-md"
            style={{ fontFamily: 'Great Vibes, cursive' }}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-purple-700 text-xl md:text-2xl leading-relaxed font-semibold" 
                 style={{ fontFamily: 'Montserrat, sans-serif' }}>
                Esta invitación especial ha sido diseñada exclusivamente para dispositivos móviles.
              </p>
              
              <p className="text-purple-800 text-lg md:text-xl" 
                 style={{ fontFamily: 'Montserrat, sans-serif' }}>
              ...
              {/* QR code placeholder */}
              <motion.div
                className="mt-8 p-6 bg-white/30 rounded-xl"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1.2, duration: 0.8 }}
              >
                <p className="text-purple-700 text-sm font-medium mb-4" style={{ fontFamily: 'Montserrat, sans-serif' }}>
          ...
          <motion.div
            className="text-purple-700 text-xl italic mt-8 drop-shadow-md"
            style={{ fontFamily: 'Great Vibes, cursive' }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
